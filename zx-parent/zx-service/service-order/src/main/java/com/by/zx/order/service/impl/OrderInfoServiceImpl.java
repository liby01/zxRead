package com.by.zx.order.service.impl;

import com.by.zx.common.exception.DiyException;
import com.by.zx.feign.cart.CartFeignClient;
import com.by.zx.feign.product.ProductFeignClient;
import com.by.zx.feign.user.UserFeignClient;
...
import com.by.zx.order.mapper.OrderInfoMapper;
import com.by.zx.order.mapper.OrderItemMapper;
import com.by.zx.order.mapper.OrderLogMapper;
    ...
    public Long submitOrder(OrderInfoDto orderInfoDto) {
        ...
        for(OrderItem orderItem : orderItemList) {
            ...
            if(orderItem.getSkuNum().intValue() > productSku.getStockNum().intValue()) {
                throw new DiyException(ResultCodeEnum.STOCK_LESS);
            }
        }
